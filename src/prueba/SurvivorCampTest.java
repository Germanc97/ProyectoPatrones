...
public class SurvivorCampTest extends TestCase{
	...
	private void setupEscenario4 () {
		...
		try {
			...
			fail("No se est�n cargando los puntajes");
		}
	...
	/**
	 * Comprueba que al lanzar una granada, no vaya a aumentar m�s puntos de los que ya estaban muertos
	 * y que los que ya se est�n muriendo no cambien su estado
	 */
	...
	/**
	 * comprueba que se ordenen los puntajes seg�n la cantidad de tiros a la cabeza, de mayor a menor
	 */
	...
	/**
	 * Comprueba que ordene los puntajes seg�n la cantidad de bajas, de mayor a menor
	 */
	...
	/**
	 * Comprueba que ordene los puntajes seg�n el score, de mayor a menor
	 */
	...
	/**
	 * comprueba que busque correctamente el mejor puntaje del nombre ingresado por par�metro
	 */
